...
use Omnipay\Segpay\Message\NotificationServerRequest;

class SegPayGateway extends AbstractGateway
{

    const ENDPOINT_TEST = 'https://test.vala....com';
    const ENDPOINT_LIVE = 'https://vala....com';
    ...
    {
        return 'Segpay Payment Copy and Pay';
    }
