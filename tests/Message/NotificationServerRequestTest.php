...
use Omnipay\Segpay\SegpayGateway;
...
class NotificationServerRequestTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->gateway = new SegpayGateway($this->getHttpClient(), $request);
    ...
    {
        $notification = $this->gateway->acceptNotification();
        $this->assertSame('Omnipay\Segpay\Message\NotificationServerResponse', get_class($notification->sendData($notification->getData())));
    }
